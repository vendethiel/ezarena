...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr> 
		<td class="row2">
		<table cellpadding="0" cellspacing="0" border="0"><tr><td>&nbsp;&nbsp;&nbsp;{catrow.forumrow.INDENT}</td><td>
		<span class="gen">{catrow.forumrow.FORUM_ICON_IMG}&nbsp;&nbsp;<a href="{catrow.forumrow.U_VIEWFORUM}" target="_new" title="{catrow.forumrow.L_FORUM_DESC_LONG}{catrow.forumrow.FORUM_DESC_LONG}">{catrow.forumrow.FORUM_NAME}</a></span><br /><span class="gensmall">{catrow.forumrow.FORUM_DESC}<br /><br />
</span></td>
		</tr></table></td>
	...
	<tr>
		<td colspan="7" height="1" class="spaceRow"><img src="../templates/Appalachia/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END catrow -->
	<tr>
