      ...
      message_die(GENERAL_ERROR, "Couldn't remove ban_userid info into database", "", __LINE__, __FILE__, $sql); 
			...
			$sql = "UPDATE " . USERS_TABLE . "
				SET " . $username_sql . $passwd_sql . "
					...
					user_use_rel_date = $use_rel_date,
					user_use_rel_time = $use_rel_time,
					...
					user_gender = '$gender',
					user_points = $points,
					admin_allow_points = $allow_points" . $avatar_sql . ",
...
//-- fin mod : birthday --------------------------------------------------------			
			...
			$s_hidden_fields .= '<input type="hidden" name="user_colortext" value="' . str_replace("\"", "&quot;", $user_colortext) . '" />';			
