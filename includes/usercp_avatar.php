...
//-- mod : quick post es & birthday & flags  -------------------------------------------------------
// here we added
//	, &$user_qp_settings
...
//	, &$gender
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$yim, &$website, &$location, &$occupation, &$interests, &$flag, &$bday_day, &$bday_month, &$bday_year, &$signature, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$colortext, &$allowhtml, &$allowbbcode, &$allowsmilies, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings, &$gender)
//-- fin mod : flags -----------------------------------------------------------
...
// here we added
//	, 'bday_day', 'bday_month', 'bday_year'
//	, 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more', list($bday_day, $bday_month, $bday_year) = explode('-', $bday_date);
//	, 'flag'
//	, 'colortext'
//	, 'gender'
//-- modify	
	$params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'yim', 'website', 'location', 'occupation', 'interests', 'flag', 'bday_day', 'bday_month', 'bday_year', 'signature', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'colortext', 'allowhtml', 'allowbbcode', 'allowsmilies', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more', 'gender');
//-- fin mod : flags -----------------------------------------------------------	
//-- fin mod : quick post es ---------------------------------------------------
//-- fin mod : birthday --------------------------------------------------------	
