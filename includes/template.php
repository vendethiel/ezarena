...
class Template {
	...
	function set_rootdir($dir)
	{
		...
		$this->tpl = defined('IN_ADMIN') ? $this->tpldef : $this->template_name($dir);
	...
	{
		global $board_config;
		if (false !== strpos($filename, 'areabb/mods/') && (ROOT_STYLE == 'admin')) $filename = '../../'.$filename;
		if (false !== strpos($filename, 'areabb/cache/') && (ROOT_STYLE == 'page')) $filename = '../../'.$filename;
		if (false !== strpos($filename, 'areabb/mods/') && (ROOT_STYLE == 'page')) $filename = '../../'.$filename;
		...
		for($i=0; $i<$line_count; $i++)
		{
			...
			*/
			if($keyword_type == XS_TAG_INCLUDE)
			{
				...
				$line = '<'.'?php ';
				$line .= ' $this->set_filename(\'xs_include_' . $filehash . '\', \'' . $params_str .'.tpl\', true); ';
