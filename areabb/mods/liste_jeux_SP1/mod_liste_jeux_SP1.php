<?php
/*********************************************************************
*		  mod_liste_jeux_SP1.php
*
*  Commencé le lundi 29 Mai 2006 par Saint-Pere - www.yep-yop.com
*
*  Affichage de la liste des jeux sous la forme de petites vignettes avec un minimum d'infos.
*  Ce type d'affichage permet de mettre un grand nombre de jeux par page.
*
**********************************************************************/
if ( !defined('IN_PHPBB') )
{
...
$template->set_filenames(array(
      'arcade_liste_jeux_SP1' => 'areabb/mods/liste_jeux_SP1/tpl/arcade_liste_jeux_SP1.tpl'
));
...
if ($nbjeux == 0) 
{
	...
	{
		// intialisation
		$gamepic= ''; $gameset = '';$norecord = '';$highuser =	'';$imgfirst = '';
