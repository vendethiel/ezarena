...
<table width="100%" height="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
        ...
        <tr>
          ...
          <td class="row2">
                <input type="password" class="post" name="new_password" size="20" maxlength="100" value="{PASSWORD}" />
          </td>
        </tr>
        <tr>
          ...
          <td class="row2">
                <input type="password" class="post" name="password_confirm" size="20" maxlength="100" value="{PASSWORD_CONFIRM}" />
          </td>
        </tr>
        ...
        <tr>
          ...
          <td class="row2"><input type="text" class="post" name="confirm_code" size="6" maxlength="6" value="" /></td>
        </tr>
