...
<tr> 
<td class="row1">{L_VIGNETTE_LARGE}<br />
<span class="gensmall">{L_VIGNETTE_LARGE_EXPLAIN}</span></td>
<td class="row2"> 
<input type="text" size="40" maxlength="255" name="game_pic_large" value="{GAME_VIGNETTE_LARGE}" class="post" />
</td>
</tr>
<tr> 
	<td class="row1">{L_CHEATER}<br /></td>
	<td class="row2"> 
		{L_YES}<input type="radio" name="cheater" value="1" {s_cheater_yes}>
		{L_NO}<input type="radio" name="cheater" value="0" {s_cheater_no}>
	</td>
</tr>
