...
* picker.js
*
* This file was modified by reddog to be used and compatible with rank color system mod.
...
var form_widget_amount_slider_handle = './../templates/_shared/picker/images/slider_handle.gif';
...
* previewColor
*
* This function was added by reddog to be used with rank color system mod
	...
	do {
		if ( subDiv.tagName=='DIV' && subDiv.className != 'cp_closebutton' )
		{
			if ( subDiv == thisObj )
			{
				...
				img.src = "./../templates/_shared/picker/images/tab_right_active.gif"
			...
			else
			{
				...
				img.src = "./../templates/_shared/picker/images/tab_right_inactive.gif";
				if ( activeColorDiv )
				{
...
function createColorPickerTopRow(inputObj)
{
	...
	for ( var no = 0; no < tabs.length; no++ )
	{
		...
		tabImg.src = "./../templates/_shared/picker/images/tab_right_" + suffix + ".gif";
