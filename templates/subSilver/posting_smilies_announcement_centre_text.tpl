...
function emoticon(text) {
	text = ' ' + text + ' ';
	if (opener.document.forms['post'].announcement_text_draft.createTextRange && opener.document.forms['post'].announcement_text_draft.caretPos) {
		var caretPos = opener.document.forms['post'].announcement_text_draft.caretPos;
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ? text + ' ' : text;
		opener.document.forms['post'].announcement_text_draft.focus();
	} else {
	opener.document.forms['post'].announcement_text_draft.value  += text;
	opener.document.forms['post'].announcement_text_draft.focus();
	}
}
//-->
