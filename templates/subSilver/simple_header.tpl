...
td.rowpic {
		...
		background-image: url(templates/{T_TEMPLATE_NAME}/images/{T_TH_CLASS3});
...
th	{
	...
	background-image: url(templates/{T_TEMPLATE_NAME}/images/{T_TH_CLASS2});
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(templates/{T_TEMPLATE_NAME}/images/{T_TH_CLASS1});
...
@import url("templates/{T_TEMPLATE_NAME}/formIE.css"); 
-->
</style>
...
<script type="text/javascript" src="templates/_shared/js_libs.js"></script>
<link rel="stylesheet" href="templates/{T_TEMPLATE_NAME}/rcs_stylesheet.css" type="text/css">
</head>
