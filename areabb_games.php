...
if ((($flashgametime > $plus) || ($flashgametime < $moins) || ($temps_depart < 1) // tps serveur différent du tps coté joueur..
		|| ($variable_flash != $variable)) // probleme d'onglets ou alors la personne tente de submitter un score par un autre moyen.
	 && ($row['game_cheat_control'] == 1)) // l'Anti triche doit être Activé
{
