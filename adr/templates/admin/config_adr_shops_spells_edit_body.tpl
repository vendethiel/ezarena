...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="90%">
	...
	<tr>
		<td class="row1">{L_ITEM_TYPE}<br /><span class="gensmall"><i>{L_ITEM_TYPE_EXPLAIN}</i></span></td>
		<td class="row2" align="center" >{ITEM_TYPE}</td>
	</tr>
	<tr>
		<td class="row1">{L_ITEM_LEVEL}</td>
	...
	<tr>
        ...
        <tr>
                <td class="row1">{L_CLASS_LIMIT}<span class="gensmall"><br /><i>{L_CLASS_LIMIT_EXPLAIN}</i></span></td>
