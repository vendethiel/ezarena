...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="90%">
	...
	<tr>
		<td class="row1">{L_SEASON}</td>
		<td class="row2" align="center" ><span class="gensmall">{ZONE_SEASON}</span></td>
	</tr>
	<tr>
		<td class="row1">{L_WEATHER}</td>
		<td class="row2" align="center" ><span class="gensmall">{ZONE_WEATHER}</span></td>
	</tr>
	<tr>
		<td class="row1">{L_ZONE}</td>
		<td class="row2" align="center" ><span class="gensmall">{ZONE_LIST}</span></td>
	</tr>
	<tr>
		<td class="row1">{L_ITEM}</td>
		<td class="row2" align="center" ><span class="gensmall"> {ZONE_ITEM}</span></td>
	</tr>
	<tr>
		<td class="row1">{L_MESSAGE_ENABLE}</td>
		<td class="row2" align="center" ><span class="gensmall"><input type="checkbox" name="message_enable" value="1" {ZONE_MESSAGE_ENABLE} /></span></td>
	</tr>
	<tr>
		<td class="row1">{L_MESSAGE}</td>
		<td class="row2" align="center" ><span class="gensmall"><textarea name="message" cols="60" rows="10" class="post">{ZONE_MESSAGE}</textarea></span></td>
	</tr>
