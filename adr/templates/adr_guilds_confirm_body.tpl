...
<!-- BEGIN guilds_create_confirm -->
<br />
<table class="forumline" align="center" width="900" cellspacing="1" cellpadding="3" border="0">
	<tr>
		<th class="thHead" height="25" valign="middle" colspan="2" width="892" ><span class="tableTitle">{L_GUILDS_CREATE_TITLE}</span></th>
	</tr>
    <tr>
		<td class="row3" align="center" colspan="2" width="892" ><span class="gen">{L_GUILDS_CREATE_TEXT}</span>
	</tr>
    </tr>
	<tr>
...
<!-- BEGIN guilds_apply_confirm -->
<br />
<table class="forumline" align="center" width="900" cellspacing="1" cellpadding="3" border="0">
	<tr>
		<th class="thHead" height="25" valign="middle" colspan="2" width="892" ><span class="tableTitle">{L_GUILDS_APPLY_TITLE}</span></th>
	</tr>
    <tr>
		<td class="row3" align="center" colspan="2" width="892" ><span class="gen">{L_GUILDS_APPLY_TEXT}</span>
	</tr>
    </tr>
	<tr>
...
<!-- BEGIN guilds_leave_confirm -->
<br />
<table class="forumline" align="center" width="900" cellspacing="1" cellpadding="3" border="0">
	<tr>
		<th class="thHead" height="25" valign="middle" colspan="2" width="892" ><span class="tableTitle">{L_GUILDS_LEAVE_TITLE}</span></th>
	</tr>
    <tr>
		<td class="row3" align="center" colspan="2" width="892" ><span class="gen">{L_GUILDS_LEAVE_TEXT}</span>
	</tr>
    </tr>
	<tr>
...
<!-- BEGIN guilds_leader_delete_confirm -->
<br />
<table class="forumline" align="center" width="900" cellspacing="1" cellpadding="3" border="0">
	<tr>
		<th class="thHead" height="25" valign="middle" colspan="2" width="892" ><span class="tableTitle">{L_GUILDS_DELETE_TITLE}</span></th>
	</tr>
    <tr>
		<td class="row3" align="center" colspan="2" width="892" ><span class="gen">{L_GUILDS_DELETE_TEXT}</span>
	</tr>
    </tr>
	<tr>
