...
<table border="0" cellpadding="4" cellspacing="1" width="811" class="forumline" align="center">
	<tr>
		<td class="row2" width="801" colspan="3" align="center"><b><font size="6">{U_GUILDS_LEADER}{L_GUILDS_LEADER_CP}</font></b></td>
	</tr>
	<tr>
		<td class="row1" width="801" colspan="3">&nbsp;</td>
	</tr>
	<tr>
		<td class="row2" width="801" colspan="3"><p align="center"><i><font size="4">
        &quot;{U_GUILDS_LEADER_GUILD_DESC}&quot;</font></i></td>
	</tr>
	<tr>
    	...
    	<tr>
		<td class="row2" width="801" colspan="3"><b>{L_GUILDS_INFO}</b></td>
	</tr>
	<tr>
		<td class="row1" width="298">&nbsp;</td>
		<td class="row1" width="296" align="center">&nbsp;</td>
		<td class="row1" align="center" rowspan="7" >{U_GUILDS_INFO_LOGO}</td>
	</tr>
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_LEADER}</font></td>
		<td class="row1" width="296" align="center"><font size="2">{U_GUILDS_INFO_LEADER}</font></td>
	</tr>
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_LEVEL}</font></td>
		<td class="row1" width="296" align="center"><font size="2">{U_GUILDS_INFO_LEVEL}</font></td>
	</tr>
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_MEMBERS}</font></td>
		<td class="row1" width="296" align="center"><font size="2">{U_GUILDS_INFO_MEMBERS} </font></td>
	</tr>
	<tr>
		<td class="row1" width="294"><font SIZE="2">{L_GUILDS_INFO_VAULT}</font></td>
		<td class="row1" width="293">
        <p align="center"><font size="2">{U_GUILDS_INFO_VAULT} {L_GUILDS_INFO_POINTS}</font></td>
	</tr>
	<tr>
		<td class="row1" width="294"><font SIZE="2">{L_GUILDS_INFO_DATE}</font></td>
		<td class="row1" width="293">
        <p align="center"><font size="2">{U_GUILDS_INFO_DATE}</font></td>
	</tr>
	<tr>
		<td class="row1" width="302"><font SIZE="2">{L_GUILDS_INFO_LENGTH}</font></td>
		<td class="row1" width="301">
        <p align="center"><font size="2">
        {U_GUILDS_INFO_DATE2}{L_GUILDS_INFO_DATE2}</font></td>
		</tr>
    <tr>
		<td class="row1" width="603" colspan="2">&nbsp;</td>
		<td class="row1" align="center" width="189" >{U_GUILDS_INFO_EXP}</td>
	</tr>
    <tr>
		<td class="row1" width="603" colspan="2">&nbsp;</td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
    ...
    <tr>
		<td class="row2" width="801" colspan="3"><b>{L_GUILDS_MANAGEMENT}</b></td>
	</tr>
    <tr>
		<td class="row1" width="603" colspan="2">&nbsp;</td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
	...
	<tr>
		<td class="row2" width="801" colspan="3"><b>{L_GUILDS_INFO_JOIN_REQS}</b></td>
	</tr>
	<tr>
		<td class="row1" width="298">&nbsp;</td>
		<td class="row1" width="296" align="center">&nbsp;</td>
	...
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_JOIN_ACCEPT_NEW}</font></td>
		<td class="row1" width="296" align="center"><span class="gen"><input type="radio" name="accept_new" value="1" {U_GUILDS_ACCEPT_NEW_CHECKED} />{L_YES}&nbsp;<input type="radio" name="accept_new" value="0" {U_NO_GUILDS_ACCEPT_NEW_CHECKED} />{L_NO}</span></td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
	</tr>
      <tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_JOIN_APPROVE_NEW}</font></td>
		<td class="row1" width="296" align="center"><span class="gen"><input type="radio" name="approve_enable" value="1" {U_GUILDS_APPROVE_NEW_CHECKED} />{L_YES}&nbsp;<input type="radio" name="approve_enable" value="0" {U_NO_GUILDS_APPROVE_NEW_CHECKED} />{L_NO}</span></td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
	</tr>
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_JOIN_LEVEL}</font></td>
		<td class="row1" align="center" width="296" >
        <input class="post" type="text" maxlength="3" size="5" name="min_join_level"  value="{U_GUILDS_INFO_JOIN_LEVEL}" tabindex="1" /></td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
	</tr>
	<tr>
		<td class="row1" width="298"><font SIZE="2">{L_GUILDS_INFO_JOIN_MONEY}</font></td>
		<td class="row1" width="296" align="center">
        <input class="post" type="text" maxlength="3" size="5" name="min_join_money"  value="{U_GUILDS_INFO_JOIN_MONEY}" tabindex="2" /></td>
		<td class="row1" align="center" width="189" >&nbsp;</td>
	</tr>
	<tr> 
	  <td class="row1" colspan="3" height="28" width="801">&nbsp;</td>
	</tr>
	<tr> 
	  <td class="row1" colspan="3" height="28" width="801">&nbsp;</td>
	</tr>
	<tr> 
	  <td class="row2" colspan="3" height="28" width="801"><b>{L_GUILDS_LEADER_GENERAL}</b></td>
	</tr>
	<tr>
		<td class="row1" width="298">&nbsp;</td>
		<td class="row1" align="center" width="296" >
	...
	<tr>
	  ...
	  <td class="row1" height="28" width="296">&nbsp;</td>
	  <td class="row1" height="28" width="189">&nbsp;</td>
	</tr>
    <tr>
	...
	<tr>
		<td class="catBottom" align="center" colspan="3" width="801"><input type="hidden" name="mode" value="guilds_leader_page_update" />
...
<br />
  <table width="100%" align="center" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <th class="thTop" colspan="10" nowrap="nowrap" width="892">{L_USERS_LIST}</th>
	</tr>
	<tr> 
...
<!-- BEGIN rows -->
	<tr> 
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="299"><span class="gen">{guilds_users.rows.USERS_ROW}</span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_NAME}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_LEVEL}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_HP}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_MP}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_WINS}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_DEFEATS}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_FLEES}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">{guilds_users.rows.USERS_HOPS}</a></span></td>
	  <td class="{guilds_users.rows.ROW_CLASS}" align="center" width="300"><span class="gen">
		<input type="hidden" name="guild_id" value="{GUILD_ID}" />
