...
<table width="100%" border="2" cellspacing="1" cellpadding="3" align="center">
	...
	<tr>
		<td class="row2" align="center" colspan="3" ><span class="gen"><img src="adr/images/TownMap_Environment/Banque_totalcompte.gif "/><br />{L_OPENED_ACCOUNTS} : {ACCOUNTS}</span> </td>
	</tr>
	<tr>
		<td class="row2" align="center" colspan="3" ><span class="gen"><img src="adr/images/TownMap_Environment/Banque_totalrichesse.gif "/><br />{L_TOTAL_DEPOSIT} : {TOTAL_DEPOSIT} {L_POINTS}</span> </td>
	</tr>
...
<table width="100%" border="2" cellspacing="1" cellpadding="3" align="center">
	...
	<tr>
		<td class="row2" align="center" ><span class="gen"><img src="adr/images/TownMap_Environment/Banque_poche.gif "/><br />{L_OWNER_POINTS} : {POINTS} {L_POINTS}</span> </td>
	</tr>
	<tr>
		<td class="row2" align="center" ><span class="gen"><img src="adr/images/TownMap_Environment/Banque_compte.gif "/><br />{L_NO_ACCOUNT}</span> </td>
	</tr>
...
<table width="100%" border="2" cellspacing="1" cellpadding="3" align="center">
	...
	<tr>
		<td class="row2" align="center" ><span class="gen"><img src="adr/images/TownMap_Environment/Banque_compte.gif "/><br />{L_ACCOUNT} : {ACCOUNT_SUM} {L_POINTS}</span> </td>
	</tr>
...
<table width="100%" border="2" cellspacing="1" cellpadding="3" align="center">
	...
	<tr>
		<td class="row2" align="center" ><br /><img src="adr/images/TownMap_Environment/Banque_liste.gif "/><br /><br /><input type="submit" value="{L_VAULT_LIST}" name="list" class="mainoption" /><br /><br /></td>
	</tr>
	<!-- BEGIN stock -->
	<tr>
		<td class="row3" align="center" ><br /><img src="adr/images/TownMap_Environment/Banque_bourse.gif "/><br /><br /><input type="submit" value="{L_STOCK_EXCHANGE}" name="stock_exchange" class="mainoption" /><br /><br /></td>
	</tr>
