...
<table border="0" cellpadding="4" cellspacing="1" width="811" class="forumline" align="center">
	...
	<tr>
    	...
    	<tr>
		<td class="row2" width="810" colspan="3"><b>{L_GUILDS_INFO}</b></td>
	</tr>
    	<tr>
	...
	<tr>
		<td class="row2" width="810" colspan="3"><b>{L_GUILDS_INFO_JOIN_REQS}</b></td>
	</tr>
	<tr>
		<td class="row1" width="587" colspan="2">&nbsp;</td>
		<td class="row1" align="center" width="223" >&nbsp;</td>
...
<br />
  <table border="0" cellpadding="4" cellspacing="0" align="center" width="811" class="forumline" style="border-collapse: collapse" bordercolor="#111111">
	...
	<tr>
		...
		<td class="row1" width="405" colspan="4" style="border-left-style: solid; border-left-width: 1">&nbsp;</td>
	</tr>
	<tr>
		<td class="row1" width="405" colspan="4" style="border-right-style: solid; border-right-width: 1">&nbsp;</td>
		<td class="row1" width="405" colspan="4" style="border-left-style: solid; border-left-width: 1">&nbsp;</td>
