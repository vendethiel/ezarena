...
function copyright() 
    ...
    echo "<html>\n"
		...
		."&bull; &nbsp;<b>Hack Title:</b> Advanced Dungeons &amp; Rabbits<br>\n"
		."&bull; &nbsp;<b>Hack Version:</b> 0.4.5<br>\n"
		."&bull; &nbsp;<b>License:</b> GNU/GPL<br>\n"
		."&bull; &nbsp;<b>Author:</b> Seteo-Bloke<br>\n"
		."&bull; &nbsp;<b>Author's Email:</b> <a href='mailto:webmaster@adr-support.com'>Primary</a><br>\n"
		."&bull; &nbsp;<b>Hack Description:</b> This mod adds a way for users to interact
		in a very customisable Role Playing Game (RPG).<br>			
		<br>\n"
		. "Basé sur la prémodée par ShadowTek en version 0.3.4, mise à jour en version 0.4.5 par Informpro<br>"
