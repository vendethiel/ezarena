...
if ( defined ( 'IN_ADR_SHOPS' ))
{
   ...
   $lang['Adr_items_type_weapon']='Arme';
...
if ( defined ('IN_ADR_BATTLE'))
{
   ...
   $lang['Adr_battle_attack_success']='%s frappe %s avec un(e) %s [élément %s] et inflige %s point(s) de dégâts !';
   $lang['Adr_battle_attack_success_norm']='%s frappe %s avec un(e) %s et inflige %s point(s) de dégâts !';
   $lang['Adr_battle_attack_weap_str']='%s frappe %s avec un(e) %s [élément plus fort] et inflige %s point(s) de dégâts !';
   $lang['Adr_battle_attack_weap_same']='%s frappe %s avec un(e) %s [élément égal] et inflige %s point(s) de dégâts !';
   $lang['Adr_battle_attack_weap_weak']='%s frappe %s avec un(e) %s [élément plus faible] et inflige %s point(s) de dégâts !';
   ...
   $lang['Adr_battle_attack_bare']='%s inflige %s point(s) de dégâts à %s à mains nues !';
