...
{ 
   ...
   $lang['Adr_guilds_join_approve']='Approbation du demandeur par le Chef de Guilde:'; 
   $lang['Adr_guilds_join_approve_enabled']='Permis'; 
   $lang['Adr_guilds_join_approve_disabled']='Pas permis'; 
   ...
   $lang['Adr_guilds_join_pm_msg']='%s s\'est joint avec succes %s'; 
   ...
   $lang['Adr_guilds_logo_none']='Aucun ensemble de logo'; 
   ...
   $lang['Adr_guilds_leader_approve']='Attente de la Liste d\'Approbation'; 
   ...
   $lang['Adr_guilds_leader_rank_leader']='Titre fait sur commande du chef de la guilde:'; 
   $lang['Adr_guilds_leader_rank1']='Custom Rang 1 titre:'; 
   $lang['Adr_guilds_leader_rank2']='Custom Rang 2 titre:'; 
   $lang['Adr_guilds_leader_rank3']='Custom Rang 3 titre:'; 
   $lang['Adr_guilds_leader_rank4']='Custom Rang 4 titre:'; 
   $lang['Adr_guilds_leader_rank5']='Custom Rang 5 titre:'; 
   $lang['Adr_guilds_leader_bio']='Mise à jour Configuration de la Guilde'; 
   $lang['Adr_guilds_leader_rank_member']='Custom \'Generale Membres\' rang:'; 
   $lang['Adr_guilds_leader_page_updated']='Arrangements du chef mis à jour avec succès'; 
