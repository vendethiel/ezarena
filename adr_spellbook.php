...
if ( $view_spells_skill != "" )
{
		switch($view_spells_skill)
		{
			case 'evocation' :
				...
				$recipebook_action = append_sid("adr_spellbook.$phpEx?view_spells_skill=evocation&amp;known_spells=$known_spells");
			...
			case 'healing' :
				...
				$recipebook_action = append_sid("adr_spellbook.$phpEx?view_spells_skill=healing&amp;known_spells=$known_spells");
			...
			case 'abjuration' :
				...
				$recipebook_action = append_sid("adr_spellbook.$phpEx?view_spells_skill=abjuration&amp;known_spells=$known_spells");
			...
			break;
				...
				$existing_spell = ( isset($_POST['known_spells']) ) ? trim($_POST['known_spells']) : trim($_GET['known_spells']);
